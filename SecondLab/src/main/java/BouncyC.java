...
public class BouncyC {
    ...
    public static void main(String[] args) throws CertificateException, NoSuchProviderException, KeyStoreException, IOException, UnrecoverableKeyException {
        ...
        try {
            ...
            String secretMessage = "My password is sophiacrumb2020";
